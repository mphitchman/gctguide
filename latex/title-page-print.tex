...
%\vskip2.5in
	...
	\resizebox{.8\linewidth}{!}{\color{nc}  \scshape Geometry}
	
	\vskip.3in
	
	\resizebox{.6\linewidth}{!}{\color{black!80} \scshape with an Introduction to}
	
	\vskip.2in
	\resizebox{.6\linewidth}{!}{\color{nc} \scshape Cosmic Topology}
	...
	\resizebox{.65\linewidth}{!}{\color{nc}\scshape Michael P. Hitchman}
