...
\begin{center}
	...
	\fill[color=blue!20] (o) circle (1cm);
	...
	\vskip-2.5in
	\resizebox{.8\linewidth}{!}{\scshape Geometry}
	
	\vskip1.7in
	
	\resizebox{.6\linewidth}{!}{\scshape with an Introduction to}
	
	\vskip.2in
	\resizebox{.7\linewidth}{!}{\scshape Cosmic Topology}
	
	
	
	\vskip1.96in
	\resizebox{.6\linewidth}{!}{\scshape Michael P Hitchman}
